    ...
    >
      <div className="pointer-events-auto max-w-6xl mx-auto flex flex-col items-center">
        ...
        >
          <div className="relative shrink-0">
            ...
            <div className="relative h-10 w-10 sm:h-11 sm:w-11 rounded-xl p-px bg-linear-to-b from-[#f472b6] via-peach to-lilac-solid border border-white/60 shadow-[0_4px_16px_-4px_rgba(236,72,153,0.5)] transition-all duration-300 group-hover:border-rose/60">
        ...
        <nav
          ...
          className="hidden items-center gap-1 bg-plum/80 p-1 rounded-xl border border-rose/15 lg:flex"
        >
          {tabs.map((tab) => (
            <Link
              key={tab.to}
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className="group relative hidden lg:inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-linear-to-r from-[#f472b6] via-rose to-peach text-white text-xs font-extrabold tracking-wide shadow-[0_4px_14px_-2px_rgba(236,72,153,0.55),inset_0_1px_0_rgba(255,255,255,0.5)] hover:shadow-[0_6px_20px_-2px_rgba(236,72,153,0.65),0_0_18px_rgba(251,146,60,0.4)] hover:-translate-y-0.5 active:translate-y-0 transition-all duration-200 cursor-pointer overflow-hidden border border-white/50"
          >
          ...
          <button
            ...
            className="flex items-center gap-2 rounded-xl border border-rose/30 bg-white/85 backdrop-blur-md px-3.5 py-1.5 text-xs font-bold text-ink shadow-sm lg:hidden hover:bg-plum transition-all cursor-pointer"
          >
      ...
      {open ? (
        <nav
          ...
          className="pointer-events-auto max-w-6xl mx-auto mt-2 overflow-hidden rounded-3xl border border-rose/25 bg-white/95 backdrop-blur-2xl shadow-[0_24px_60px_-15px_rgba(236,72,153,0.35)] p-4 lg:hidden animate-in fade-in slide-in-from-top-2 duration-200"
        >
          <div className="space-y-1">
            {tabs.map((tab) => (
              <Link
                ...
                onClick={() => setOpen(false)}
                activeOptions={{ exact: tab.to === '/' }}
                className="flex items-center justify-between rounded-2xl px-4 py-3 font-display text-lg text-ink hover:bg-plum transition-colors"
            ...
            <button
              ...
              className="mt-3 flex items-center justify-center gap-2 w-full py-3 rounded-xl bg-linear-to-r from-[#f472b6] via-rose to-peach text-white text-xs font-extrabold tracking-wide shadow-md cursor-pointer"
            >
...
export function Footer() {
  ...
  return (
    <footer className="relative z-10 overflow-hidden rounded-t-[3rem] bg-linear-to-b from-white via-plum to-[#fff7ed] text-ink border-t border-rose/20 md:rounded-t-[5rem]">
      ...
      <div className="wrap relative pt-14 pb-7 md:pt-20">
        <div className="grid gap-10 pb-12 sm:grid-cols-2 lg:grid-cols-[1.2fr_0.7fr_1fr_1fr]">
          <div>
            <div className="flex items-center gap-3">
              <div className="relative h-12 w-12 sm:h-14 sm:w-14 rounded-xl p-px bg-linear-to-b from-[#f472b6] via-peach to-lilac-solid border border-white/70 shadow-[0_4px_20px_rgba(236,72,153,0.3)]">
                <div className="h-full w-full rounded-[11px] overflow-hidden bg-plum flex items-center justify-center">
                  <img
                    src="/api/images/logo"
                    alt="GoldBlack Lash — logotipo"
                    width={120}
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="mt-6 inline-flex rounded-xl border border-rose/25 bg-white px-5 py-3 text-xs font-bold text-[#db2777] transition-all hover:bg-plum hover:border-rose/50 focus-visible:outline-accent shadow-sm"
            >
        ...
        <div className="flex flex-col justify-between gap-3 border-t border-rose/15 pt-7 text-[0.65rem] leading-6 text-muted sm:flex-row">
          <p>
