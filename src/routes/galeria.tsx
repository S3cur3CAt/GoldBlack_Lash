        ...
        {piece.elements && piece.elements.length > 0 && (
          <div className="mt-3.5 flex flex-wrap gap-1.5">
            {piece.elements.map((el, i) => (
              <span
                key={i}
                className="inline-flex items-center gap-1 rounded-md bg-linear-to-r from-[#fbcfe8] via-[#fed7aa] to-[#ddd6fe] px-2.5 py-0.5 text-[0.65rem] font-bold text-[#831843] border border-white/70 shadow-xs"
              >
                <span className="text-[0.6rem] text-[#db2777]">✦</span>
                <span>{el}</span>
              </span>
            ))}
          </div>
            ...
            {piece.elements && piece.elements.length > 0 && (
              <div className="mt-4 flex flex-wrap gap-1.5">
                {piece.elements.map((el, i) => (
                  <span
                    key={i}
                    className="inline-flex items-center gap-1.5 rounded-lg bg-linear-to-r from-[#fbcfe8] via-[#fed7aa] to-[#ddd6fe] px-3 py-1 text-xs font-bold text-[#831843] border border-white/70 shadow-sm"
                  >
