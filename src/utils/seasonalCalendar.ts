...
/**
 * Resuelve el efecto concreto que debe mostrarse en función del modo seleccionado y de la fecha actual.
 * Si effect === 'auto', calcula automáticamente la festividad o estación según el día del año.
 */
export function resolveSeasonalEffect(
  ...
  // 3. San Valentín: 7 de Febrero al 16 de Febrero (semana previa y posterior)
  ...
  // 5. Halloween: 20 de Octubre al 2 de Noviembre (días antes y después de Halloween)
  ...
  // 7. Resto del año (verano, junio, julio, agosto, etc.): Polvo de oro atelier de la casa
  return 'gold_dust'
}
